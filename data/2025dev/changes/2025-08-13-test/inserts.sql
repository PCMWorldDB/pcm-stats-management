-- Generated SQL INSERT statements for 2025-08-13-test
-- Review before executing

-- Step 1: tbl_changes and tbl_cyclists
INSERT INTO tbl_changes (name, description, author, date)
VALUES ('2025-08-13-test', 'run test c', 'neal', '2025-08-13');
...
VALUES (
    ...
    (SELECT id FROM tbl_changes WHERE name = '2025-08-13-test'),
    'cob',
    40,
    COALESCE(
